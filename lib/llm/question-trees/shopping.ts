...
import { FixedQuestionResponse, ExplorationGoal, SubPathProbing } from "./types";
...
export const shoppingExplorationGoals: Record<string, ExplorationGoal> = {
  impulse: {
    ...
    // NOTE: probingHints and targetModes are defined at the subpath level (impulseSubPathProbing)
  ...
  deliberate: {
    ...
    // NOTE: probingHints and targetModes are defined at the subpath level (deliberateSubPathProbing)
    counterProfilePatterns: [],
  },
  deal: {
    path: "deal",
    goal: "Distinguish between genuine value and deal-induced impulse buying",
    // NOTE: probingHints and targetModes are defined at the subpath level (dealSubPathProbing)
    counterProfilePatterns: ["I was already planning to buy this", "I would have bought it anyway"],
  },
  gift: {
    path: "gift",
    goal: "Explore gift-giving patterns",
    // NOTE: probingHints and targetModes are defined at the subpath level (giftSubPathProbing)
    counterProfilePatterns: [],
  },
  maintenance: {
    path: "maintenance",
    goal: "Verify true necessity",
    // NOTE: probingHints and targetModes are defined at the subpath level (maintenanceSubPathProbing)
    counterProfilePatterns: [],
  },
};
